...
const UserPost = () => {
  ...
  const userAvatar = localStorage.getItem("avatar") || "https://randomuser.me/api/portraits/men/32.jpg";
    ...
    <div className="app-container">
      ...
      <nav className="app-sidebar">
        ...
        <div className="sidebar-menu">
          ...
          <div className="menu-item" onClick={() => navigate("/posts/createpost")}>
        ...
        <div className="user-profile">
          ...
          <div className="profile-info">
            ...
            <span className="profile-title" onClick={() => navigate("/posts/userdetails")}>View Profile</span>
          </div>
        </div>
      </nav>
          ...
          <div className="main-feed">
            ...
            <div className="create-post-card">
              ...
              <div className="post-actions">
                ...
                <button className="post-action">
                  <i className="bi bi-play-btn" style={{color: "#7FC15E"}}></i>
                  <span>Video</span>
                </button>
                <button className="post-action">
                  <i className="bi bi-calendar-event" style={{color: "#E7A33E"}}></i>
                  <span>Event</span>
                </button>
                <button className="post-action">
                  <i className="bi bi-newspaper" style={{color: "#FC9295"}}></i>
